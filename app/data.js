  ...
  checklist: [
    {
      ...
      items: [
        { id: 'c1', label: 'General Principles — 25 cards', done: true,  type: 'flashcards', priority: 'high' },
        { id: 'c2', label: 'Risk Management & Insurance — 30 cards', done: true,  type: 'flashcards', priority: 'high' },
        { id: 'c3', label: 'Investment Planning — 28 cards', done: false, type: 'flashcards', priority: 'high' },
        { id: 'c4', label: 'Tax Planning — 26 cards', done: false, type: 'flashcards', priority: 'high' },
        { id: 'c5', label: 'Retirement & Employee Benefits — 30 cards', done: false, type: 'flashcards', priority: 'medium' },
        { id: 'c6', label: 'Estate Planning — 24 cards', done: false, type: 'flashcards', priority: 'medium' },
      ],
    },
    {
      id: 'cl-calc', title: 'Calculations', area: 'calc',
      items: [
        { id: 'k1', label: 'Time Value of Money guide', done: true,  type: 'calculations', priority: 'high' },
        { id: 'k2', label: 'Retirement needs analysis', done: false, type: 'calculations', priority: 'high' },
        { id: 'k3', label: 'Education funding', done: false, type: 'calculations', priority: 'medium' },
        { id: 'k4', label: 'Bond valuation & yield', done: false, type: 'calculations', priority: 'medium' },
        { id: 'k5', label: 'Tax liability walkthrough', done: false, type: 'calculations', priority: 'high' },
        { id: 'k6', label: 'Net worth & cash-flow statements', done: false, type: 'calculations', priority: 'low' },
      ],
    },
    {
      id: 'cl-refs', title: 'References', area: 'refs',
      items: [
        { id: 'r1', label: 'Traditional vs Roth IRA table', done: true,  type: 'references', priority: 'high' },
        { id: 'r2', label: 'Roth conversion decision tree', done: true,  type: 'references', priority: 'high' },
        { id: 'r3', label: 'Account titling comparison', done: false, type: 'references', priority: 'medium' },
        { id: 'r4', label: 'Trust selection decision tree', done: false, type: 'references', priority: 'medium' },
        { id: 'r5', label: 'Education funding options table', done: false, type: 'references', priority: 'low' },
      ],
    },
  ],
